...
import com.idbgm.abcgalinhapintadinha.R;
...
public class MainActivity extends Activity {	 
	...
	public void LoadSounds() {	
		...
		try {										 
		    ...
		    for (int i = 65; i <= 90; i++ ) {
		    	...
		    	String file = "sounds/abc1/" + letter + ".mp3";
	...
	public void playMusic(String soundName) {
	    ...
	    try {
	    	...
	    	String file = "sounds/abc1/" + soundName + ".mp3";
	...
	public void playVideo(int soundName) {
	    ...
	    try {
	    	...
	    	String uriPath = "android.resource://com.idbgm.abcgalinhapintadinha/"+soundName;
